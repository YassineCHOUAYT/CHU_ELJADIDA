            ...
            <div class="row d-flex justify-content-start align-items-center mt-sm-5">
                ...
                <div class="col-lg-4 offset-lg-2 col-md-6 offset-md-3">
                    ...
                    <div class="mt-3 mt-md-5">
                        ...
                        <form class="pt-4" method="POST" action="../LoginServlet">
                        	<!-- <style>
                        		label{
                        			font-weight: bold;
                        		}
                            ...
                            <div class="d-flex flex-column pb-3"> <label for="password">Mot de passe</label> <input type="password" name="motDePasse" id="pwd" class="border-bottom border-primary" onpaste="return false;" placeholder="Saisir votre mot de passe ici" required="required"> </div>
